...
import NFTService from '../service/profile.service';
...
function Createnft() {
  ...
  const submitButton = async(e) => {
    ...
    // }
    // console.log("Nft form data:",nftData);
    var data = new FormData();
    data.append('itemFile', itemFile);
    data.append('itemname', itemname);
    data.append('itemdescription', itemdescription);
    data.append('auctionStartDate', auctionStartDate);
    data.append('auctionEndDate', auctionEndDate);

    NFTService.createNFT(data).then(response =>{
      console.log("Check Response:",response);
    })
    console.log("Check Files:",itemFile);
        ...
        <div className="container">
          <div className="row row--grid">
            ...
            <div className="col-12 col-xl-9">
              ...
              {/* end title */}
              {/* create form */}
              <form  className="sign__form sign__form--create" encType="multipart/form-data">
                <div className="row">
                  ...
                  <div className="col-12">
                    <div className="sign__group">
                      ...
                      <textarea id="description" name="description" value={itemdescription}  onChange={e => setItemDescription(e.target.value)} className="sign__textarea" placeholder="e. g. 'After purchased you will get downloadable zip file'" />
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="sign__group">
                      <label className="sign__label" htmlFor="auctionstartdate">Auction start date</label>
                      <input id="auctionstartdate" type="date" name="auctionstartdate" value={auctionStartDate} onChange={e => setAuctionStartDate(e.target.value)}   className="sign__input" placeholder="e. g. 'Set Start Date'" />
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="sign__group">
                      <label className="sign__label" htmlFor="auctionenddate">Auction end date</label>
                      <input id="auctionenddate" type="date" name="auctionenddate" value={auctionEndDate}  onChange={e => setAuctionEndDate(e.target.value)} className="sign__input" placeholder="e. g. 'Set End Date'" />
                    </div>
                  </div>
