...
function Home() {
  ...
  useEffect(() => {
    //getLives function Call
    getAllLives();
    //getMintings function Call
    getAllMintings();
  }, []);
  function getAllMintings() {
    Service.getAllMinting().then((response) => {
      const res = response.data.results;
      res.filter((x) => {
        setMintings(x.userAddress);
        console.log("Check:", x.userAddress);
      });
    });
  }
  const getAllLives = () => {
    Service.getAllLiveAuctions()
      .then((response) => {
        const res = response.data.results;
        setLives(res);
      })
  ...
  return (
    <main class="main">
      <div
        class="home"
        style={{ backgroundImage: `url("img/home/home-1.jpg")` }}
      >
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <div class="home__content">
                ...
                <p class="home__text">
                  ...
                  collectibles <br /> and non-fungible tokens. Buy And sell
                  digital assets.{" "}
                </p>

                <div class="home__btns">
                  <a href="explore.html" class="home__btn">
                    {" "}
                    Explore <i class="fal fa-rocket"></i>
                  </a>
                  <a href="signin.html" class="home__btn home__btn2">
                    Create <i class="fal fa-edit"></i>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="row row--grid">
            <div class="col-12">
              <div class="main__title">
                <h2>
                  <a href="explore.html">Live auctions</a>
                </h2>
              </div>
            </div>
            <div class="col-12">
                    ...
                    <div class="item">
                      <div class="card">
                        <a href="item.html" class="card__cover">
                          <img
                            src={
                              "http://localhost:5000/uploads/" + item.itemFile
                            }
                            alt=""
                            height="150px"
                          />
                        ...
                        <h3 class="card__title">
                          <a href="item.html">{item.itemname}</a>
                        </h3>
              ...
              <div class="main__carousel-wrap">
                ...
                >
                  <div class="card">
                    <a href="item.html" class="card__cover">
                      <img
                        src="http://localhost:5000/uploads/Screenshot%20(1).png"
                        alt=""
                      />
                    </a>
                    <h3 class="card__title">
                      <a href="item.html">Awesome Color Drop</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/8.jpg" alt="" />
                      <a href="author.html">@morgan28</a>
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">Beautiful Leaf In The Wall</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/7.jpg" alt="" />
                      <a href="author.html">@nessler520</a>
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">Blue Planet Revolution</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/6.jpg" alt="" />
                      <a href="author.html">@kimberly28</a>
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">Colorful Fantacy Flowers</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/5.jpg" alt="" />
                      <a href="author.html">@patricia458</a>
                    ...
                    <div class="card__info">
                      ...
                      <button
                        class="card__likes card__likes--active"
                        type="button"
                      >
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">Let's Go The Navy Blue Galaxies</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/4.jpg" alt="" />
                      <a href="author.html">@humphrey124</a>
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">3D Ethereum In Diamond</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/3.jpg" alt="" />
                      <a href="author.html">@sheilagne22</a>
                  ...
                  <div class="card">
                    ...
                    <h3 class="card__title">
                      <a href="item.html">Fantacy Of Water Drop</a>
                    </h3>
                    <div class="card__author card__author--verified">
                      <img src="assets/img/avatars/2.jpg" alt="" />
                      <a href="author.html">@kimberly120</a>
                ...
                >
                  <div class="collection">
                    <a
                      ...
                      data-bg="assets/img/collection/1.jpg"
                    ></a>
                    <div class="collection__meta">
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Abstract Geniuses</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/2.jpg"
                    ></a>
                    <div class="collection__meta">
                      <a
                        href="author.html"
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Virtual Worlds</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/3.jpg"
                    ></a>
                    <div class="collection__meta">
                      <a
                        href="author.html"
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Digital Arts</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/4.jpg"
                    ></a>
                    <div class="collection__meta">
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Trading Cards</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/5.jpg"
                    ></a>
                    <div class="collection__meta">
                      <a
                        href="author.html"
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Modern Photography</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/6.jpg"
                    ></a>
                    <div class="collection__meta">
                      <a href="author.html" class="collection__avatar">
                        <img src="assets/img/avatars/6.jpg" alt="" />
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Digital Token</a>
                      </h3>
                  ...
                  <div class="collection">
                    <a
                      href="collection.html"
                      class="collection__cover"
                      data-bg="assets/img/collection/7.jpg"
                    ></a>
                    <div class="collection__meta">
                      <a
                        href="author.html"
                      ...
                      <h3 class="collection__name">
                        <a href="collection.html">Analogue Refraction</a>
                      </h3>
          ...
          <div class="call-to-action-inr">
            <div class="cta-overlay">
              <div class="cta-content">
                ...
                <p class="cta-desc">
                  Aliquam viverra enim commodo sed consequat tempor sit nisl
                  cursus lectus.
                </p>
        ...
        <div class="container">
          <div class="row row--grid">
            <div class="col-12">
              <div class="main__title">
                <h2>Latest blog</h2>
                <a href="blog.html" class="main__link">
                ...
                <div class="post__content">
                  ...
                  <div class="post__meta">
                    <span class="post__date">
                      {" "}
                      <i class="far fa-clock"></i> Sep 14, 2021
                    </span>
                    <span class="post__author">
                      <i class="far fa-user"></i> Danielle Rector
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-3">
              <div class="feature">
                ...
                <p class="feature__text">
                  Click Create & set up your colecton Add social links and a
