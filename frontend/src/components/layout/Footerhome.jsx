			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="footer__lang">
						<a class="footer__lang-btn" href="#" role="button" id="dropdownLang" data-bs-toggle="dropdown"
				...
				<div class="col-md-2">
					<h6 class="footer__title">Netland</h6>
				...
				<div class="col-md-3">
					...
					<div class="footer-newsletter">
						<p>Subscribe our newsletter to get more update & join to netland.</p>
						<form action="#">
